...
pub fn lower_tuple<'gc_, 'a, 'f>(
    ...
    _source: Value<'gc_>,
        ...
        let PrimValue::Value(tup) = super::misc::lower_make_tuple(ssa, &[Atom::Constant(Value::new(args.len() as i32))], _source) else {
...
pub fn lower_vector_ref<'gc_, 'a, 'f>(
    ...
    _source: Value<'gc_>,
        ...
        super::arith::ensure_vector(ssa, vec,
            |ssa, ulen, slowpath| {
                super::arith::fixnum_in_bounds_usize(ssa, ix, ulen,
                    |ssa, ix, _slowpath| {
