...
use crate::runtime::{
    Context,
    value::{
        Closure, ReturnCode, Str, Value, Vector,
    },
};


pub fn wrong_number_of_args<'gc>(ctx: Context<'gc>,
        subr: Value<'gc>,
        got: usize,
        expected: isize,
...
pub fn cons_rest_regs<'gc>(ctx: Context<'gc>,
        argc: usize,
        arg0: Value<'gc>,
        arg1: Value<'gc>,
        arg2: Value<'gc>,
...
pub fn raise_condition_regs<'gc>(ctx: Context<'gc>,
        code: usize,
        argc: usize,
        arg0: Value<'gc>,
        arg1: Value<'gc>,
...
pub fn raise_condition_with_source_regs<'gc>(ctx: Context<'gc>,
        code: usize,
        argc: usize,
        arg0: Value<'gc>,
        arg1: Value<'gc>,
...
pub fn non_applicable<'gc>(ctx: Context<'gc>,
...
pub fn generic_apply_regs<'gc>(ctx: Context<'gc>,
        generic: Value<'gc>,
        argc: usize,
        arg0: Value<'gc>,
        arg1: Value<'gc>,
