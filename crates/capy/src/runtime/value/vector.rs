...
impl<'gc> Vector<'gc> {
    ...
    pub fn from_slice(mc: Context<'gc>, slice: &[Value<'gc>]) -> Gc<'gc, Self> {
    ...
    pub fn fill(this: Gc<'gc, Self>, fill: Value<'gc>, mc: Context<'gc>) {
    ...
    pub fn copy_from(self: Gc<'gc, Self>, other: impl AsRef<[Value<'gc>]>, mc: Context<'gc>) {
...
fn mapped_bytevector_header_word() -> u64 {
    class_header_word(
        ClassId::new(builtin_class_ids::MAPPED_BYTEVECTOR).expect("builtin class id is nonzero"),
    )
}
...
impl ByteVector {
    ...
    pub fn new_mapping<'gc>(mc: Context<'gc>, addr: Address, length: usize) -> Gc<'gc, Self> {
        // SAFETY: Preconditions verified by the surrounding code
        unsafe {
            let alloc = mc.raw_allocate_with_header_word(
                size_of::<Self>(),
    ...
    #[inline(never)]
    pub fn from_slice<'gc>(mc: Context<'gc>, slice: &[u8], movable: bool) -> Gc<'gc, Self> {
        let length = slice.len();
...
unsafe impl<'gc> ClassTagged for Vector<'gc> {
    const CLASS_IDS: &'static [u32] = &[crate::heap::object::builtin_class_ids::VECTOR];
...
unsafe impl ClassTagged for ByteVector {
    const CLASS_IDS: &'static [u32] = &[
        crate::heap::object::builtin_class_ids::MUTABLE_BYTEVECTOR,
        crate::heap::object::builtin_class_ids::IMMUTABLE_BYTEVECTOR,
        crate::heap::object::builtin_class_ids::MAPPED_BYTEVECTOR,
    ];
...
unsafe impl<'gc> ClassTagged for Tuple<'gc> {
    const CLASS_IDS: &'static [u32] = &[crate::heap::object::builtin_class_ids::TUPLE];
...
impl<'gc> Tuple<'gc> {
    ...
    pub fn new(mc: Context<'gc>, length: usize, init: Value<'gc>) -> Gc<'gc, Self> {
        // SAFETY: Preconditions verified by the surrounding code
        unsafe {
            let alloc = mc.raw_allocate_with_header_word(
                size_of::<Self>() + size_of::<Value>() * length,
    ...
    pub fn copy_from(this: Gc<'gc, Self>, other: impl AsRef<[Value<'gc>]>, mc: Context<'gc>) {
        let tuple = Gc::write(mc, this);
        let other_slice = other.as_ref();
