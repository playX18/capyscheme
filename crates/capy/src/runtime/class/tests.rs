...
use crate::heap::object::{AllocationHooksOf, ClassId, MAX_CLASS_ID, builtin_class_ids};
use crate::heap::{Gc, Trace, Visitor};
...
fn class_table_initialization_registers_pending_type_classes() {
    crate::runtime::thread::Scheme::new_uninit().enter(|ctx| {
        ...
        let class_id = crate::heap::object::allocate_class_id();
        crate::heap::object::record_pending_type_class(class_id, hooks);
...
fn initialized_class_table_disables_pending_type_class_fallback() {
    crate::runtime::thread::Scheme::new_uninit().enter(|ctx| {
        ...
        let unregistered_id = crate::heap::object::allocate_class_id();
...
fn dynamic_registration_reports_exhaustion() {
    crate::runtime::thread::Scheme::new_uninit().enter(|ctx| {
        let next_id = crate::heap::object::peek_next_class_id();
