...
- *(cfg)* Optimize return continuations in SBBV - ([d5b6e02](https://codeberg.org/playXE/capy/commit/d5b6e0212257d53be5c171c0ef77f8914a6f8fee))
...
- *(compiler)* Per-site shared closure environments (EnvRecord) - ([5bbdbd4](https://codeberg.org/playXE/capy/commit/5bbdbd49cbf78cf48372c7b71502e6a61d54a644))
...
- Self host more passes; graph library - ([f61361c](https://codeberg.org/playXE/capy/commit/f61361c11052130751b14a9ba2c0dc70a172b989))
- Self-host fixing letrec and assignment elimination - ([f251118](https://codeberg.org/playXE/capy/commit/f251118a248336c5c16283f60434e3bfa8725389))
- Add CST reader - ([75ab941](https://codeberg.org/playXE/capy/commit/75ab941320f37d655f046eb878b82bbbf139befc))
...
- *(bbv)* Widen slots of closures: prevents garbage values - ([5380a4a](https://codeberg.org/playXE/capy/commit/5380a4a12a82814c8b861c146840805109afc450))
...
- *(capy term)* Handle isattty only when fd is integer - ([5b4de0e](https://codeberg.org/playXE/capy/commit/5b4de0ebbaf93c535fe9024b0a4630fda6a2b27a))
...
- *(compiler)* Tighten BigInt in BBV + GC write barriers - ([b8eb316](https://codeberg.org/playXE/capy/commit/b8eb316682427ca1317dced2d7d3a5e861ff31af))
...
- *(gc)* Allocate ThreadObject/Mutex/Condition/Poller in LOS, not NonMoving - ([4c951bb](https://codeberg.org/playXE/capy/commit/4c951bb03fff086c984b05cd0dac4612c859687f))
- *(gc)* Trace every registered thread's roots in the GC root scan - ([dafa8c7](https://codeberg.org/playXE/capy/commit/dafa8c7eaff4216e967612874a854b28aad77c2e))
- *(gc)* Use Reentrant Mutex for class table access - ([9ab5727](https://codeberg.org/playXE/capy/commit/9ab57275a46c482613b7ae04584e82e4a25ee64b))
...
- *(ports)* Fd was not properly handled - ([cf99c35](https://codeberg.org/playXE/capy/commit/cf99c35b065e28b04ca5afecffcebd486ae5e077))
...
- *(threading)* Root variables during thread creation to avoid GC collection - ([60a710a](https://codeberg.org/playXE/capy/commit/60a710af920b4237355c79e5a1b99069779fbc2f))
...
- Remove dead code - ([a4ef428](https://codeberg.org/playXE/capy/commit/a4ef4288eccb032488398443369751f09d2d3ea5))
- Sort bindings when fixing letrec - ([307c9d4](https://codeberg.org/playXE/capy/commit/307c9d4cc24b7d21b61a60c5806d1ede1ec8103b))
- Write barrier on cache_set - ([3a92d99](https://codeberg.org/playXE/capy/commit/3a92d9913f1e367750b3dda680242a73d5d5fac5))
- Small stdlib fixes - ([e7ff3e7](https://codeberg.org/playXE/capy/commit/e7ff3e797035a23932993f583d523b09bba15d57))
- Makefile update BOOT_SRCS - ([bc0ca7f](https://codeberg.org/playXE/capy/commit/bc0ca7f881f886fe2d66b61cdd42579a746e5be1))
...
- *(capy/graph)* Rewrite tarjan SCC impl - ([f0020df](https://codeberg.org/playXE/capy/commit/f0020df630a3d66876b88a5ecf2a5acd46fb3bc0))
...
- *(srfi)* Full SRFI 214 + performance tuning - ([054c53a](https://codeberg.org/playXE/capy/commit/054c53a0dd0f003d77ef6bfe0b5a1d6a01bb3a8a))
- Rework flags for dumping, and add proper flag parser - ([cc85ace](https://codeberg.org/playXE/capy/commit/cc85ace8cdad4b54758759cb801a6d81187f158e))
- Harden fix-letrec - ([06984c2](https://codeberg.org/playXE/capy/commit/06984c244aa6108da9af4b8c8b9b766758ab29ad))
- Update MMTk, improve GC stats and add Chez-style time syntax - ([08a7c42](https://codeberg.org/playXE/capy/commit/08a7c4258a56bbc97d7e88aba19c9958642f05b6))
...
- Udpate dependencies - ([771d723](https://codeberg.org/playXE/capy/commit/771d723ca59802fba9af4069a27ba904aea32786))
...
- *(makefile)* Use GenImmix during bootstrap, more reliable/less OOMs on 2GB heap - ([a34001d](https://codeberg.org/playXE/capy/commit/a34001d7264b3191d61e0a010e39c722a600182a))
