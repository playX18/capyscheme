//! Inherents
//!
//! Values which are always defined by the VM, regardless of the
//! current context.
...
unsafe impl Trace for Inherent {
...
impl Inherent {
    pub const MNEMONIC_COUNT: usize = Self::S_CODE_LITTLE as usize;
    pub const INSTRUCTION_COUNT: usize = Self::VMOP_GLOC_OF as usize;
    pub const TOTAL: usize = Self::LAST as usize;
}
