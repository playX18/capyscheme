                     ...
                     (define (decode2)
                       (if (<= 2 count)
                         (let* ((unit2
                                ...
                                (sv
                                  (logior
                                    (ash (logand unit1 #b00011111) 6)
                                    (logand unit2 #b00111111))))
                     ...
                     (define (decode3)
                       (if (<= 3 count)
                         (let* ((unit2
                                ...
                                (sv
                                  (fxior
                                    (ash (logand unit1 #b00001111) 12)
                                    (ash (logand unit2 #b00111111) 6)
                                    (logand unit3 #b00111111))))
                           (string-set! s i (integer->char sv))
                           (continue 3))
                         (loop2 s 0 i)))
                     ...
                     (define (decode4)
                       (if (<= 4 count)
                         (let* ((unit2
                                ...
                                (sv
                                  (fxior
                                    (ash (logand unit1 #b00000111) 18)
                                    (ash (logand unit2 #b00111111) 12)
                                    (ash (logand unit3 #b00111111) 6)
                                    (logand unit4 #b00111111))))
                           (string-set! s i (integer->char sv))
                           (continue 4))
                         (loop2 s 0 i)))
